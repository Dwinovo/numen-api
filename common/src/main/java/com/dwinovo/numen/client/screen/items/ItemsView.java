...
public final class ItemsView {
    ...
    private static void renderPortrait(GuiGraphicsExtractor g, AbstractClientPlayer e,
    ...
    private static void slotBg(GuiGraphicsExtractor g, Identifier sprite, int x, int y) {
        g.blitSprite(net.minecraft.client.renderer.RenderPipelines.GUI_TEXTURED, sprite, x, y, 16, 16);
    }

    private static void stackOn(GuiGraphicsExtractor g, Font font, ItemStack st, int x, int y, int mouseX, int mouseY) {
    ...
    private static void drawEquip(GuiGraphicsExtractor g, Font font, AbstractClientPlayer e, EquipmentSlot slot,
