...
public final class NumenScreen extends Screen {
    ...
    private void buildSummonField() {
        ...
        boolean canChooseMode = this.minecraft != null && this.minecraft.player != null
                && this.minecraft.player.permissions().hasPermission(
    ...
    private void renderSummonDropdowns(GuiGraphicsExtractor g, int mouseX, int mouseY) {
    ...
    private boolean mouseClickedInner(net.minecraft.client.input.MouseButtonEvent event, boolean doubleClick) {
    ...
    private void renderInner(GuiGraphicsExtractor g, int mouseX, int mouseY, float partial) {
        ...
        if (summoning) {
            ...
            if (summonModeDropdown == null) {
                ...
                if (mouseX >= mx0 && mouseX < mx0 + summonHalfW()
                    ...
                    g.setTooltipForNextFrame(font, Component.literal(
        ...
        if (summoning && warnUntil > System.currentTimeMillis() && warnText != null) {
            g.text(font, warnText, sumX(), sumY0() + 186, 0xFFCC6666, false);
        }
        if (summoning) {
