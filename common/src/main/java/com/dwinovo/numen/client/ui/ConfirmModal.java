...
public final class ConfirmModal {
    ...
    public static void render(GuiGraphicsExtractor g, Font font, int scrimX0, int scrimX1, int top, int panelH,
                              Component title, Component warn) {
    ...
    private static int drawWrapped(GuiGraphicsExtractor g, Font font, Component c, int color,
