...
public final class NumenNetwork {
    ...
    public static void register() {
        ...
        Services.NETWORK.registerClientToServer(
                com.dwinovo.numen.network.payload.SpeechBubblePayload.ID,
                com.dwinovo.numen.network.payload.SpeechBubblePayload::read,
                com.dwinovo.numen.network.payload.SpeechBubblePayload::handle);

        // S→C: 气泡状态转发给同伴附近的所有玩家——说话路人也看得见。
        Services.NETWORK.registerServerToClient(
                com.dwinovo.numen.network.payload.SpeechBubbleSyncPayload.ID,
                com.dwinovo.numen.network.payload.SpeechBubbleSyncPayload::read,
